...
private:
    ...
    quat euler2quatern(euler angle){
	  ...
	  qt.q1 =   cosPsi*cosTheta*cosPhi + sinPsi*sinTheta*sinPhi;
	  qt.q2 = -(cosPsi*cosTheta*sinPhi - sinPsi*sinTheta*cosPhi);
	  qt.q3 = -(cosPsi*sinTheta*cosPhi + sinPsi*cosTheta*sinPhi);
	  qt.q4 = -(sinPsi*cosTheta*cosPhi - cosPsi*sinTheta*sinPhi);
