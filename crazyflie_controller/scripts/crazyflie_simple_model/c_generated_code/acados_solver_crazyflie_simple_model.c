...
int acados_create() {
    ...
    for (int i = 0; i < N; ++i) {
        forw_vde_casadi[i].casadi_fun = &crazyflie_simple_model_expl_vde_forw;
        forw_vde_casadi[i].casadi_n_in = &crazyflie_simple_model_expl_vde_forw_n_in;
        forw_vde_casadi[i].casadi_n_out = &crazyflie_simple_model_expl_vde_forw_n_out;
        forw_vde_casadi[i].casadi_sparsity_in = &crazyflie_simple_model_expl_vde_forw_sparsity_in;
        forw_vde_casadi[i].casadi_sparsity_out = &crazyflie_simple_model_expl_vde_forw_sparsity_out;
        forw_vde_casadi[i].casadi_work = &crazyflie_simple_model_expl_vde_forw_work;
